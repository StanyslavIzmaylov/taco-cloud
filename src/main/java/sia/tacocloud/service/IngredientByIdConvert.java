...
import sia.tacocloud.service.Ingredient.Type;
...
public class IngredientByIdConvert implements Converter<String,Ingredient> {
    ...
    public IngredientByIdConvert(){
        ingredientMap.put("FLTO",new Ingredient("FTLTO","Flour Tortillia", Type.WRAP));
        ...
        ingredientMap.put("JACK",(new Ingredient("JACK","Monterry", Type.CHEESE)));
